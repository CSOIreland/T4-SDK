...
if (!hs) {
    var hs = {
        ...
        graphicsDir: 'https://www.cso.ie/images/highslide/graphics/',
    ...
    hs.Ajax.prototype = {
        run: function() {
            ...
            try { xhr = new XMLHttpRequest(); } catch (e) {
                try { xhr = new ActiveXObject("Msxml2.XMLHTTP"); } catch (e) {
                    try { xhr = new ActiveXObject("Microsoft.XMLHTTP"); } catch (e) { this.onError(); }
                }
            }
            var pThis = this;
        ...
        getElementContent: function() {
            ...
            this.iframe = hs.createElement('iframe', attribs, { position: 'absolute', top: '-9999px' }, hs.container);
