...
class CSOOrgChart {
    constructor(el) {
        console.log("Org chart init", "cso-org-chart-feature-container", "cso-org-chart-feature-data");
    ...
    init(el = document.body) {
        try {
            ...
            const orgchart = new OrgChart({
                'chartContainer': `.${"cso-org-chart-feature-container"}`,
                'data': `#${"cso-org-chart-feature-data"}`,
            });
