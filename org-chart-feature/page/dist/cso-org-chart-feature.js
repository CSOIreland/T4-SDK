    ...
    extractDataFromContainer(dataNode, isChild = false) {
        ...
        try {
            if (isChild) {
                ...
                const node = ((_a = dataNode === null || dataNode === void 0 ? void 0 : dataNode.tagName) === null || _a === void 0 ? void 0 : _a.toLowerCase()) == 'li' ? dataNode : dataNode === null || dataNode === void 0 ? void 0 : dataNode.querySelector('li');
                if (node) {
